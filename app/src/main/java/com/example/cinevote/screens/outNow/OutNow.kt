...
@Composable
fun OutNowScreen(
    navController: NavHostController, state: OutNowStatus, action: FilmAction
) {
    ...
    Scaffold(containerColor = MaterialTheme.colorScheme.background, topBar = {
        TopBar(
            navController = navController, title = stringResource(R.string.outNow_title)
        )
    }, bottomBar = { bottomAppBar(navController) }, content = { innerPadding ->

...
@Composable
fun ReviewScreen(
    navController: NavHostController, title: String, state: ReviewState,
    action: ReviewAction,
) {
    ...
    Row {
        repeat(5) { index ->
            IconButton(
                ...
                Icon(
                    painter = if (index < selectedStars) painterResource(id = R.drawable.star) else painterResource(
                        id = R.drawable.outlined_star
                    ),
